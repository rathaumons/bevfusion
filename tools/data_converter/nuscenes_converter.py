...
def create_nuscenes_infos(root_path,
                          ...
                          max_sweeps=10,
                          max_radar_sweeps=10,
                          half_train_val=False):
    """Create info file of nuscene dataset. Given the raw data, generate its related info file in pkl format.
    Args:
        ...
        half_train_val (bool): Make half of the scenes for train and the other for val. Default: False
    """
    from nuscenes.nuscenes import NuScenes
...
def get_available_scenes(nusc):
    """Get available scenes from the input nuscenes class. Given the raw data, get the information of available 
    scenes for further info generation.
    Args:
...
def _fill_trainval_infos(nusc,
    ...
    Args:
        ...
        max_radar_sweeps (int): Max number of radar sweeps. Default: 10.
    Returns:
        tuple[list[dict]]: Information of training set and validation set that will be saved to the info file.
    """
    train_nusc_infos = []
    val_nusc_infos = []
    token2idx = {}
...
def get_2d_boxes(nusc,
    ...
    Return:
        list[dict]: List of 2D annotation record that belongs to the input `sample_data_token`.
    """
...
def post_process_coords(
    ...
    Args:
        corner_coords (list[int]): Corner coordinates of reprojected bounding box.
        imsize (tuple[int]): Size of the image canvas.
    Return:
        tuple [float]: Intersection of the convex hull of the 2D box corners and the image canvas.
    """
