...
- Only [CUDA 12.1](https://docs.nvidia.com/cuda/cuda-installation-guide-linux/) & [cuDNN 8.9](https://docs.nvidia.com/deeplearning/cudnn/latest/installation/linux.html)
