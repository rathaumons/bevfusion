...
For more details, see [test.py](https://github.com/rathaumons/bevfusionx/blob/cu113/tools/test.py).
...
For more details, see [train.py](https://github.com/rathaumons/bevfusionx/blob/cu113/tools/train.py).
